								...
								timetableString += 	'<div class="timetable-item">'
														...
														+ '<div id="' + el.attr('id') + '-popup-' + timetables[t].id + '" class="timetable-popup zoom-anim-dialog mfp-hide">'
															...
															+ '<div class="popup-body">'
																...
																+ '<button class="timetable-popup-button change-color-button" onclick="toggleDropdown()"><i class="fas fa-palette"></i> Change Color</button>'
																+ '<div class="dropdown">'
																	...
																	+ '</div>'
																+ '</div>'
																+ '<button class="timetable-popup-button delete-button" id="' + timetables[t].name + '" onclick="deleteEntry(this)"><i class="fas fa-trash-alt"></i> Delete from Timetable</button>'
															+ '</div>'
														+ '</div>'
													+ '</div>';
							}
